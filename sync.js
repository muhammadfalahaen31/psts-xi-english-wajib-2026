 ...
 * PSTS XI ENGLISH WAJIB 2026 - SMA PLUS PGRI CIBINONG
 */
...
const SYNC_CONFIG = {
    ...
    COLLECTION: "psts_xi_wajib_submissions_2026",
    LOCAL_KEY: "PSTS_XI_ENGLISH_WAJIB_SUBMISSIONS",
    ATTEMPT_KEY: "PSTS_XI_WAJIB_MY_ATTEMPT",
    TIMER_KEY: "PSTS_XI_ENGLISH_WAJIB_TIMER_REMAINING",
...
class RealtimeSyncEngine {
    constructor() {
        ...
        this.channel = typeof BroadcastChannel !== 'undefined' ? new BroadcastChannel('psts_xi_wajib_sync_channel') : null;
        this.listeners = [];
        this.initFirebase();
    ...
    initFirebase() {
        try {
            if (typeof firebase !== 'undefined') {
                ...
                console.log("✅ [Firebase] Firestore connected for PSTS Grade XI Wajib.");
            }
        } catch (err) {
